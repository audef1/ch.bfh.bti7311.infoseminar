...
class NAT_TYPE
{
    static $_NAT_TYPE_OPENED = 0;
    static $_NAT_TYPE_FULLCONE_NAT = 1;
    static $_NAT_TYPE_REST_NAT = 2;
    static $_NAT_TYPE_PORTREST_NAT = 3;
    static $_NAT_TYPE_SYM_UDP_FIREWALL = 4;
    static $_NAT_TYPE_SYM_NAT_LOCAL = 5;
    static $_NAT_TYPE_SYM_NAT = 6;
    static $_NAT_TYPE_UDP_BLOCKED = 7;
}
